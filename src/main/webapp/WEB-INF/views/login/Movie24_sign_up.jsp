	...
	<main>
		...
		<div id="main_content">
			<div id="login_li">
				...
				<form name="enrollForm" action="/movie24/register.do" method="post">
					<div id="content_area">
						<ul>
<!-- 						<form action="/movie24/checkId.do" method="post"> -->
	...
	<script>
        ...
        function checkId(){
        	...
        	if(confirm("아이디 중복확인을 하시겠습니까?")) {
        		on = true;
        		location.href="/movie24/checkId.do?member-id="+memberId;
        	}
        }
        function myCheck(){
